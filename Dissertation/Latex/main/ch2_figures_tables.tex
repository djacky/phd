...
%\centering
%\import{}{rst.pdf_tex}
%\input{/Users/anicolet/Google Drive/EPFL Research/Research Projects/Dissertation/Latex/images/rst.pdf_tex}
%\end{figure}

\begin{figure}
\centering 
\includegraphics[width=\columnwidth]{power_converter_block} 
\caption[A floating figure]{rst}
\label{fig:tester} 
\end{figure}

\begin{figure}
\centering
\includegraphics[width=\columnwidth]{frf_uncertain}
\caption[Uncertain plot]{Measured $G\jo$ (blue-dashed) and additive uncertainty bounds for the corresponding frequency points (solid-red).}
\label{fig:plant_uncertain}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=0.6\columnwidth]{circle_rotation}
\caption[Circle plot]{circle}
\label{fig:plant_uncertain}
\end{figure}


\begin{theorem}
Hello, from \cite{NK15},ooo
\end{theorem}
